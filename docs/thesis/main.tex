...
方向的中率 HIT は，全体として $0.5$ 前後にとどまった。
$0.5$ を明確に上回ったのは上昇→下降の $W=2$（$0.584$）のみであり，
$W=60$ は 4 パターンのすべてで $0.5$ を下回った（$0.369$〜$0.497$）。
MAE では基準値 $1$ を下回る $W=2$ でも方向的中率はコイン投げと
同程度にとどまる場合があることは，
...
方向的中率 HIT も $W$ とともに概ね低下し，
$0.5$ を明確に上回ったのは転換を含む上昇→下降の $W=2$ のみであった。
