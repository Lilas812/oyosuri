...
4. 相関付きランダムウォーク：定義と n=1,2 の計算（コイン行列・P/Q 分解）
5. 相関付きランダムウォーク：n=3 の確率分布と非可換性（経路和 Ξ₃）
...
理論パート（3〜6）は、RW → 相関付きRW → 予測モデルの順に、n=1〜3 の
具体計算を踏まえて評価関数・当てはめへつなぐ構成です。7分に収めるため
やや詰め気味なので、時間が厳しければスライド5（n=3）や8（実験）を
削る・分けるなどで調整してください。
